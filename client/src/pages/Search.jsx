        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex items-center gap-2'>
            ...
            >
              ...
              <option value='createdAt_desc'>Dự án mới</option>
              <option value='createdAt_asc'>Dự án cũ</option>
            </select>
          </div>
      ...
      <div className='flex-1'>
        ...
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading && listings.length === 0 && (
            <p className='text-xl text-slate-700'>Không tìm thấy kết quả. Vui lòng thử lại !</p>
          )}
          {loading && (
